form: "Declick"
	real: "Threshold (%)", "90"
	real: "Sensitivity (%)", "80"
	boolean: "Mark detected clicks in a TextGrid", 0
	choice: "Repair method", 1
		option: "Replace"
		option: "Attenuate"
	real: "Attenuation (%)", "90"
...
include preview1.inc
	...
	if mark_detected_clicks_in_a_TextGrid and not preview
