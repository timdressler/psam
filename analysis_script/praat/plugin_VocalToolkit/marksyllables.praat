# Adapted from "Praat Script Syllable Nuclei v2" by Nivja de Jong and Ton Wempe: https://sites.google.com/site/speechrate/
...
form: "Mark regions by syllables"
	...
	positive: "Minimum pause duration (s)", "0.3"
	positive: "Minimum dip between peaks (dB)", "2"
	boolean: "Show speech rate info", 1
	boolean: "Trim initial and final silences", 1
endform
