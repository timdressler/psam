...
expName = 'tid_psam_audiotest2'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Experiments\\tid_psam\\psam\\testing\\tid_psam_audiotest2.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        sound_1.setSound('test_rect_44100fs_80ms_2ch.wav', secs=1.0, hamming=True)
