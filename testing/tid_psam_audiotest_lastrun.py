...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\timdr\\Downloads\\tid_psam_audiotest_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    testsound = sound.Sound("C:/Users/timdr/OneDrive/Uni_Oldenburg/4_Semester/Master_Thesis/Analysis_Experiment/psam/data/BIDS/stimuli/sub-99/sub-99_normal_probe.wav", speaker="sound_1")
    ...
    for thisTrial in trials:
        ...
        testsound.play(when=start_time + onset_t)
        
        
        sound_1.setSound('C:/Users/timdr/OneDrive/Uni_Oldenburg/4_Semester/Master_Thesis/Analysis_Experiment/psam/data/BIDS/stimuli/sub-99/sub-99_normal_probe.wav', secs=1, hamming=True)
